...
namespace HumanBody
{
    public class Ragdoll : MonoBehaviour
    {
        ...
        [SerializeField] public int HeadSpring;
        [SerializeField] public int HeadDamper;
        ...
        private void Awake()
        {
            ...
            // modify head
            ConfigurableJoint HeadJoint = PhysicAnimator?.GetBoneTransform(HumanBodyBones.Head).GetComponent<ConfigurableJoint>();
            tmpJoint = HeadJoint.angularXDrive;
            tmpJoint.positionSpring = HeadSpring;
            tmpJoint.positionDamper = HeadDamper;
            HeadJoint.angularXDrive = tmpJoint;
            HeadJoint.angularYZDrive = tmpJoint;
